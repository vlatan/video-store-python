...
def error_403(error):
    ...
    return render_template('error.html', title='405',
                           heading=heading, text=text), 405


@errors.app_errorhandler(500)
@errors.app_errorhandler(MismatchingStateError)
def error_500(error):
    heading = 'Something went wrong (500)'
    text = 'We are experiencing some trouble on our end. Please try again in near future.'
